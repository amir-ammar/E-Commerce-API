...
const uploadImage = async (req, res) => {
    ...
    if (!image.mimetype.startsWith('image')) throw new CustomError.BadRequestError('Please upload image')
    
    const maxSize = 1024 * 1024
    if (image.size > maxSize) throw new CustomError.BadRequestError('Please upload image with size smaller than 1MB')
